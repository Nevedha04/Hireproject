...
const CreateEmployee = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await axios.post('http://192.168.29.225:8080/api/employees/create', employee);
...
const styles = StyleSheet.create({
    ...
    input: { height: 40, borderColor: '#ccc', borderWidth: 1, borderRadius: 20, marginBottom: 15, paddingHorizontal: 10, backgroundColor: '#fff', justifyContent: 'center' },
